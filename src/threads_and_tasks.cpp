...
public:
	...
	// если вы объявили хотя бы одну из трех операций - копирующий конструктор, копирующий
	// оператор присваивания или деструктор, - то вы должны объявить все три операции

	// ПРИМЕЧАНИЕ: 
	// С++ 11 не генерирует операции перемещения для класса с пользовательским деструктором.
